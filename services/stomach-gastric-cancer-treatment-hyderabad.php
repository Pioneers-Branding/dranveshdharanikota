<?php
$route          = '/services/stomach-gastric-cancer-treatment-hyderabad';
...
$og_title       = 'Stomach & Gastric Cancer Specialist in Hyderabad | Dr. Anvesh';
          ...
          <section class="section-5" style="background: linear-gradient(to right, rgb(114, 5, 9), rgb(0, 32, 80))">
            <div class="container-5">
              <div data-reveal>
                ...
                <h1 class="page-title page-title--on-dark">Stomach Cancer Treatment in Hyderabad</h1>
